...
function NoFound() {
  ...
  return <div className="md:w-6/12 mx-auto z-10 my-10 z-1">
...
278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928         " />
      ...
      <h1  className='text-6xl'>4<span className='text-6xl' >0</span >4</h1>
      ...
      <Link to='/'>
        <Button  type='Secondary' value='HOME' callback={() => { }} ></Button>
      </Link>
    </div>
  </div>
