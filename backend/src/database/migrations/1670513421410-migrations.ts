...
export class migrations1670513421410 implements MigrationInterface {
    name = 'migrations1670513421410'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`reviews\` (\`id\` varchar(36) NOT NULL, \`description\` varchar(255) NULL, \`rating\` decimal NOT NULL, \`title\` varchar(255) NULL, \`experienceDate\` date NULL, \`createdAt\` timestamp NULL DEFAULT '2022-12-08 15:30:25', \`userId\` varchar(36) NULL, \`companyId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`companies\` (\`id\` varchar(36) NOT NULL, \`email\` varchar(255) NULL, \`name\` varchar(255) NOT NULL, \`avatar\` varchar(255) NULL, \`description\` varchar(255) NULL, \`reviewsQuantity\` float NOT NULL, \`address\` varchar(255) NULL, \`phone\` varchar(255) NULL, \`banned\` tinyint NOT NULL DEFAULT 0, \`country\` varchar(255) NULL, \`city\` varchar(255) NULL, \`website\` varchar(255) NOT NULL, \`workEmail\` varchar(255) NULL, \`ratingGeneral\` float NOT NULL DEFAULT '0', \`password\` varchar(255) NULL, \`roleId\` int NOT NULL, UNIQUE INDEX \`IDX_3e7b86aa8b4ffe84947ff29c0b\` (\`website\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
